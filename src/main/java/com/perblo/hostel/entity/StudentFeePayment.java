...
@Entity
@NamedQueries({
    @NamedQuery(name = "getStudentFeePaymentByStudentNumber",
        query = "select object(es) from StudentFeePayment es where es.studentNumber = ?1")   
})
public class StudentFeePayment implements Serializable {
